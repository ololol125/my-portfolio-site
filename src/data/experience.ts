export interface Experience {
  id: string; // ✨ 세부 페이지 주소(Dynamic Routing)로 활용할 고유 ID 필드 추가
  period: string;
  title: string;
  role: string;
  description: string[];
...
export const EXPERIENCE_DATA: Experience[] = [
  ...
  },
  {
    ...
    certificateUrl: "award01.png",
    imageUrls: ["/business-club.png", "/ex4.png"],
  },
  {
  ...
  },
  {
    ...
    period: "2026.04 - 현재",
    title:
      "경북대학교 기계공학과 채영훈 교수가 운영하는 주식회사 CLMT의 소프트웨어 엔지니어어로 근무",
    role: "software engineer, staff",
    description: [
      "주식회사 CLMT에서 소프트웨어 엔지니어어로 근무하며, 기계공학 교수의 원천 아이디어를 기반으로 비즈니스 모델을 구체화하고 상용화 할 수 있는 플랫폼을 기획하여 개발함",
    ...
    certificateUrl: "clmt_certificate.pdf",
    imageUrls: [
  ...
  },
  {
    ...
    role: "Undergraduate Research Assistant",
    description: [
      "매주 과제 미팅 and 매월 NVIDIA Korea 본사 또는 삼성서울병원 관계자들과 미팅 진행",
    ],
    imageUrls: ["/snu01.png"],
  },
];
